...
const tableSetting = async () => {
    ...
    let ph_gongsi_table = `CREATE TABLE IF NOT EXISTS ph_gongsi(
        ...
        gj_sk_gongsi VARCHAR(150),
        gj_kt_gongsi VARCHAR(150),
        gj_lg_gongsi VARCHAR(150)
    );`;
    try {
    ...
    let ph_item_table = `CREATE TABLE IF NOT EXISTS ph_item(
        ...
        it_img8 VARCHAR(255),
        it_img9 VARCHAR(255),
        it_img10 VARCHAR(255),
        it_mainstan VARCHAR(255),
        it_gongsi_model VARCHAR(50),
        it_relation_item VARCHAR(255),
        it_ph_tongsin VARCHAR(150),
        it_ph_sk_fprice VARCHAR(150),
        it_ph_sk_capa VARCHAR(150),
        it_ph_sk_newdisc VARCHAR(150),
        it_ph_sk_mnpgdisc VARCHAR(150),
        it_ph_sk_mnpsdisc VARCHAR(150),
        it_ph_sk_gibgdisc VARCHAR(150),
        it_ph_sk_gibsdisc VARCHAR(150),
        it_ph_kt_fprice VARCHAR(150),
        it_ph_kt_capa VARCHAR(150),
        it_ph_kt_newdisc VARCHAR(150),
        it_ph_kt_mnpgdisc VARCHAR(150),
        it_ph_kt_mnpsdisc VARCHAR(150),
        it_ph_kt_gibgdisc VARCHAR(150),
        it_ph_kt_gibsdisc VARCHAR(150),
        it_ph_lg_fprice VARCHAR(150),
        it_ph_lg_capa VARCHAR(150),
        it_ph_lg_newdisc VARCHAR(150),
        it_ph_lg_mnpgdisc VARCHAR(150),
        it_ph_lg_mnpsdisc VARCHAR(150),
        it_ph_lg_gibgdisc VARCHAR(150),
        it_ph_lg_gibsdisc VARCHAR(150),
        it_time DATETIME,
